        ...
        <div className="mt-14 px-6 space-y-6">
           ...
           <div className="flex gap-4">
              <div className="flex-1 bg-gray-50 p-4 rounded-2xl">
                 ...
                 <p className="font-normal text-xl text-gray-800">{new Date(selectedParty.date).toLocaleDateString('pt-BR')}</p>
              </div>
              <div className="flex-1 bg-gray-50 p-4 rounded-2xl">
                 <div className="flex items-center gap-2 text-gray-500 text-sm font-medium uppercase mb-1">
                   <Clock size={18} /> Hora
                ...
                .map(party => (
                    ...
                    >
                        <div className="flex justify-between items-start mb-3">
                            ...
                            <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide ${new Date(party.date) < new Date() ? 'bg-gray-100 text-gray-500' : 'bg-green-100 text-green-600'}`}>
                                {new Date(party.date) < new Date() ? 'Realizada' : 'Confirmada'}
                            </span>
                        </div>
                        ...
                        <div className="space-y-2">
                             <div className="flex items-center gap-2 text-gray-600">
                                 ...
                                 <span className="text-sm font-medium">{new Date(party.date).toLocaleDateString('pt-BR')}</span>
